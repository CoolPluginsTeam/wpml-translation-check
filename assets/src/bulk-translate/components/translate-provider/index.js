...
export default (props) => {
    ...
    const Services = {
        ...
        localAiTranslator: {
            ...
            BetaEnabled: true,
            ButtonDisabled: true,
            ErrorMessage: <a className='atfp-provider-error' href='https://coolplugins.net/product/automlp-ai-translation-for-wpml/?utm_source=automlp_plugin&utm_medium=inside&utm_campaign=get_pro&utm_content=bulk_translate_chrome' target="_blank">{__('Buy Pro', 'wpml-translation-check')}</a>,
            Logo: 'chrome.png',
            filterHtmlContent: true
        },
    };
