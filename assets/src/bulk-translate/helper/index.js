...
export const updateTranslateData = ({ provider, sourceLang, targetLang, parentPostId, currentPostId, editorType, updateTranslateDataNonce, extraData = {} }) => {
    ...
    const data = { provider, totalStringCount, totalWordCount, totalCharacterCount, editorType, date, sourceStringCount, sourceWordCount, sourceCharacterCount, sourceLang, targetLang, timeTaken, action: automlp_wpml_bulk_translate_object.update_translate_data, translate_data_nonce: updateTranslateDataNonce, post_id: currentPostId, ajax_url: automlp_wpml_bulk_translate_object.ajax_url, extraData: JSON.stringify(extraData), bulk_translate: true };

    fetch(automlp_wpml_bulk_translate_object.ajax_url, {
        method: 'POST',
        headers: {
