...
const App = ({ onDestory, prefix, postIds }) => {
    ...
    const emptyPostIdsErrorMessage = sprintf(__('Please select at least one %s for translation.', 'wpml-translation-check'), automlp_wpml_bulk_translate_object.post_singular_label);
                            ...
                            <div className={`${prefix}-body`}>
                                ...
                                {wizardSelectedCode ?
                                    <div className={`${prefix}-languages`}>
                                        ...
                                        &nbsp;
                                        <a href='https://coolplugins.net/product/automlp-ai-translation-for-wpml/?utm_source=automlp_plugin&utm_medium=inside&utm_campaign=get_pro&utm_content=bulk_translate' target='_blank' title={__('Buy Pro Version to Unlock All Languages', 'wpml-translation-check')} className={`${prefix}-buy-pro-version-link`}>{__('Upgrade now', 'wpml-translation-check')}</a>
                                        </p>
                                        <div>
