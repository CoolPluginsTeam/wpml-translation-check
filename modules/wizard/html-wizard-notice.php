...
$automlp_wpml_wizard_url = add_query_arg(
	array( 'page' => 'automlp_ai_wizard' ),
	admin_url( 'admin.php' )
);
$automlp_wpml_skip_url = wp_nonce_url(
...
<div class="notice notice-info is-dismissible">
	<p>
		<strong>
			...
			printf(
				...
				esc_html__( 'AutoMLP – AI Translation for WPML', 'wpml-translation-check' )
			);
			?>
		</strong>
		<?php echo ' &#8211; '; ?>
	...
	<p class="buttons">
		<a href="<?php echo esc_url( $automlp_wpml_wizard_url ); ?>" class="button button-primary">
			<?php esc_html_e( 'Run the Setup Wizard', 'wpml-translation-check' ); ?>
		</a>
		<a href="<?php echo esc_url( $automlp_wpml_skip_url ); ?>" class="button button-secondary">
